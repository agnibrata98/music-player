...
//     // Load the saved audio from localStorage when the component mounts
//     useEffect(() => {
//         const savedAudioSrc = localStorage.getItem('audioSrc');
//         const savedAudioName = localStorage.getItem('audioName');
        
//         if (savedAudioSrc && savedAudioName) {
//             setAudioSrc(savedAudioSrc);
//             setAudioName(savedAudioName);
//         }

//         const savedFavs = JSON.parse(localStorage.getItem('favArr')) || [];
//         setFavArr(savedFavs);
//     }, []);

//     // Save audioSrc and audioName to localStorage when they change
//     useEffect(() => {
...
//     // Save favArr to localStorage when it changes
//     useEffect(() => {
//         if (favArr.length > 0) {
...
function MusicPlayer() {
    ...
    // Store favorite songs in localStorage whenever favArr changes
    useEffect(() => {
        if (favArr.length > 0) {
            localStorage.setItem('favArr', JSON.stringify(favArr));
        }
    }, [favArr]); // This runs whenever favArr changes
